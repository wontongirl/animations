...
$('.nav1').click(function(){$('html,body').animate({scrollTop:$('.sec1_title').offset().top}, 800);});
$('.nav2').click(function(){$('html,body').animate({scrollTop:$('.sec2_title').offset().top}, 800);});
$('.nav3').click(function(){$('html,body').animate({scrollTop:$('.sec3_title').offset().top}, 800);});
$('.totop').click(function(){$('html,body').animate({scrollTop:$('.top_bg').offset().top}, 800);});
$('.nav_close').click(function(){
	$('.nav').css("top",'-240px')
})
$('.nav_bg2').click(function(){
	$('.nav').css("top",'130px')
})
$(".pig2").hover(function(){
    $(".pig2").css("background","url(images/pig22.png) no-repeat center top");
    $(".yao2").css("top","104px");
},function(){
    $(".pig2").css("background","url(images/pig2.png) no-repeat center top");
    $(".yao2").css("top","140px");
});
$(".pig1").hover(function(){
    $(".pig1").css("background","url(images/pig11.png) no-repeat center top");
    $(".yao1").css("top","104px");
},function(){
    $(".pig1").css("background","url(images/pig1.png) no-repeat center top");
    $(".yao1").css("top","140px");
});
...
var canvas = document.getElementById("cas");
		...
		ocas.height = canvas.height = 1047;
		var bigbooms = [];
...
//rgba(0,5,24,0.1)
		...
		function animate(){
			ctx.save();
			ctx.fillStyle = "rgba(19,2,37,0.1)";
		...
		function drawMoon(){
			...
			var centerX = canvas.width-760 , centerY =200 , width = 80;
			if(moon.complete){
