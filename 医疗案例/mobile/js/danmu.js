...
//  });
    ...
    var moveObj = function (obj) {
        ...
        var time =Math.random() *(35000- 30000) + 30000;
...
//          $("#tel2").val("");//清空输入框
//          $("#gaobai").val("");//清空输入框
            var obj = $("<span class='moveWord'>"+"<img src='" +url+"' style='position:absolute; width:1.45rem;height:1.28rem;left:-1.36rem;top:-0.5rem;'>"+ "<img src='images/feiji_bg1.png' style='position:absolute;width:0.3rem;height:0.58rem;right:-0.3rem;top:0rem;'>" + word + "</span>"); //为word值生成对象
...
var tiq='赵伟 183****7878 所爱隔山海，山海接可 ';
	var tiqq=$("<span class='moveWord' style='background:#fff;'>"+"<img src='images/feiji2.png' style='width:1.2rem;height:0.84rem;left:-1.2rem;top:-0.2rem;'>"  + tiq + "</span>");
